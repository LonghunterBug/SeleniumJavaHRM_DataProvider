...
public class UserMangementPage {
    ...
    public void editStatusEmployeeName(String username, String status_updated) {
        WebUI.sleep(5);
        searchByUserName(username);
        WebUI.clickElement(buttonEdit);
        WebUI.clickElement(selectStatus);
        WebUI.clickElement(By.xpath("//label[text()='Status']/parent::div/following-sibling::div//span[text()='" + status_updated + "']"));
        WebUI.clickElement(buttonSave);
    }
    ...
    public void verifyStatusEmployeeNameIsUpdated(String username, String status_updated) {
        WebUI.sleep(5);
        searchByUserName(username);
        WebUI.highlightElement(By.xpath("//div[contains(@class,'table-body')]//div[contains(@class,'table-row')]/div[4]"));
        String actual_status = WebUI.getElementText(By.xpath("//div[contains(@class,'table-body')]//div[contains(@class,'table-row')]/div[5]"));
        WebUI.verifyEqual(actual_status, status_updated, "Status is not macthed");
    }
